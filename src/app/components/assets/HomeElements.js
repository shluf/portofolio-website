...
const Circle = ({scrollDelta}) => {
  ...
  return (
    ...
    transition={{ type: 'spring', ...springConfig }}
    className="absolute sm:h-[25rem] sm:w-[25rem] md:h-[24rem] md:w-[24rem] h-[12rem] w-[12rem] border-dotted border-8 border-x-transparent border-y-light rounded-full" />
    ...
    <motion.span 
    className="absolute sm:h-[10rem] sm:w-[10rem] md:h-[10rem] md:w-[12rem] h-[14rem] w-[14rem] border-dashed animate-spinSlow border-[4px] border-light rounded-full" />
...
>
    <path
      ...
      stroke="#fff"
      strokeMiterlimit={10}
      d="M.713 1.087h49.333v11.516L25.38 30.953.712 10.681V1.087ZM.713 40.607h49.333v11.516L25.38 70.476.712 50.204v-9.597ZM.713 80.13h49.333v11.516L25.38 110 .712 89.727V80.13Z"
    />
  </svg>
)
